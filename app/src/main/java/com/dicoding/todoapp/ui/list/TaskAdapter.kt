...
class TaskAdapter(
    ...
    //TODO 8 : Create and initialize ViewHolder kalo error tambah ,false
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TaskViewHolder {
        val itm = LayoutInflater.from(parent.context).inflate(R.layout.task_item,parent,false)
        return TaskViewHolder(itm)
    }
